...
<section className="text-gray-600 body-font">
  <div className=" mx-auto">
    ...
    <div className="flex flex-col text-center w-full mb-10 ">
      ...
      <div className="lg:w-1/2 mb-10 flex">
...
<section id='limpeza' className="text-gray-600 body-font">
  <div className="px-5 py-2 mx-auto">
    <div className="flex items-center lg:flex-row flex-col-reverse flex-wrap -mx-4 -mb-10 text-center">
      <div className="lg:w-1/2 mb-10 h-full">
        <div className="overflow-hidden items-center ">
          <img alt="content" className="object-cover object-center h-full w-full" src="https://images.unsplash.com/photo-1487744480471-9ca1bca6fb7d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" />
        </div>
      
      </div>
      <div className="lg:w-1/2 mb-10 md:px-24 px-2 flex flex-col items-center justify-center">
        <div className='border-b border-gray-700 w-full py-2'>

        <h2 className="title-font md:text-4xl text-2xl font-medium text-gray-700 mt-6 mb-3">
